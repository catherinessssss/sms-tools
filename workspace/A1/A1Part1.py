...
def readAudio(inputFile):
    ...
    # select the 10 samples from 50001th to 50010th
    x_selected = x[50000:50010]

    #scale down and convert audio into float point number in range of -1 to 1
    return np.float32(x_selected) / norm_fact[x_selected.dtype.name]
